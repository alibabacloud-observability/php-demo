### 1. [auto-demo: 基于 OpenTelemery PHP Extension 为应用自动埋点并上报链路数据](https://github.com/alibabacloud-observability/php-demo/blob/master/opentelemetry-demo/auto-demo/README.md)
